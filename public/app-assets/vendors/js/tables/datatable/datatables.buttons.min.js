...
(function (f) {
    ...
    var q = f.fn.dataTable, M = 0, N = 0, z = q.ext.buttons, u = function (a, b) {
        ...
        this.s = {dt: new q.Api(a), buttons: [], listenKeys: "", namespace: "dtb" + M++};
        this.dom = {
    ...
    f.extend(u.prototype, {
        action: function (a, b) {
            ...
            if (b.buttons.length) for (var e = b.buttons.length - 1; 0 <= e; e--) this.remove(b.buttons[e].node);
            ...
            var d = this.s.dt, e = f(c.node), h = function (m) {
            ...
            for (var m = 0, g = b.length; m < g; m++) {
                ...
                if (l) if (Array.isArray(l)) this._expandButton(a, l, c, d); else {
            ...
            var c = this.c.dom.button,
                d = this.c.dom.buttonLiner, e = this.c.dom.collection, h = this.s.dt, m = function (n) {
            ...
            if ("absolute" ===
                ...
                var k = c.outerHeight(), n = d.offset().top + d.height(), p = l.top + h.outerHeight() + k;
                n = p - n;
                p = l.top - k;
                var r = d.offset().top, v = l.top - k - 5;
                ...
                var x = c.width();
                x = g + x;
                var w = h.offset().left, B = h.outerWidth();
                B = w + B;
                w = 0;
            ...
            f("body").on("click.dtb-collection", function (C) {
                var I = f.fn.addBack ? "addBack" : "andSelf", J = f(C.target).parent()[0];
    ...
    u.instanceSelector = function (a, b) {
        ...
        var c = [], d = f.map(b, function (h) {
                return h.name
            }),
            e = function (h) {
                if (Array.isArray(h)) for (var m = 0, g = h.length; m < g; m++) e(h[m]); else "string" === typeof h ? -1 !== h.indexOf(",") ? e(h.split(",")) : (h = f.inArray(h.trim(), d), -1 !== h && c.push(b[h].inst)) : "number" === typeof h && c.push(b[h].inst)
            };
        e(a);
        return c
    };
    u.buttonSelector = function (a, b) {
        for (var c = [], d = function (g, l, k) {
            for (var n, p, r = 0, v = l.length; r < v; r++) if (n = l[r]) p = k !== t ? k + r : r + "", g.push({
                node: n.node,
                name: n.conf.name,
                idx: p
            ...
            if (Array.isArray(g) || g instanceof f) for (p = 0, k = g.length; p < k; p++) e(g[p], l); else if (null === g || g === t || "*" === g) for (p = 0, k = n.length; p < k; p++) c.push({
                inst: l,
                node: n[p].node
            }); else if ("number" === typeof g) c.push({
                inst: l,
                node: l.s.buttons[g].node
            }); else if ("string" === typeof g) if (-1 !== g.indexOf(",")) for (n = g.split(","), p = 0, k = n.length; p < k; p++) e(n[p].trim(), l); else if (g.match(/^\d+(\-\d+)*$/)) p = f.map(n, function (r) {
                return r.idx
            }), c.push({
                inst: l,
                node: n[f.inArray(g, p)].node
            }); else if (-1 !== g.indexOf(":name")) for (g = g.replace(":name",
    ...
    f.extend(z, {
        collection: {
            ...
            return {
                ...
                }, className: "buttons-page-length", autoClose: !0, buttons: f.map(b, function (h, m) {
                    return {
                        text: c[m], className: "button-page-length", action: function (g, l) {
                            l.page.len(h).draw()
                        }, init: function (g,
                                           l, k) {
                            var n = this;
    ...
    var G = function (a) {
        ...
        }).toArray() : null, e = f.extend({},
            c.modifier);
        a.select && "function" === typeof a.select.info && e.selected === t && a.rows(c.rows, f.extend({selected: !0}, e)).any() && f.extend(e, {selected: !0});
